...
exports.createHttpTaskWithToken = async function (
  project = 'sandbox-ihommani', // Your GCP Project id
  queue = 'genius', // Name of your Queue
  location = 'us-central1', // The GCP region of your queue
  url = 'https://us-central1-sandbox-ihommani.cloudfunctions.net/getLyricsHTML', // The full url path that the request will be sent to
  email = 'sandbox-ihommani@appspot.gserviceaccount.com', // Cloud IAM service account
